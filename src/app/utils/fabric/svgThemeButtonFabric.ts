...
import { SvgThemeButton } from "../../model/svgThemeButton";
import { ThemeItem } from "../../model/themeItem";

export class SVGThemeButtonFabric {
    private _svg: Svg = new Svg();  
    private _svgThemeButton = new SvgThemeButton();

    constructor() {
    }

    GetThemeItem(itemId: string): ThemeItem{
        return this._svgThemeButton.getThemeItem(itemId);
    }

    CreateSVG(checkId: string): Svg {
        const viewBox: string = "0 0 16 16";

        let st1: Symbol = new Symbol(checkId, viewBox, ["M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z"]);
                
        let st2: Symbol = new Symbol(this.GetThemeItem("light").Id, viewBox, ["M8 12a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM8 0a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0v-2A.5.5 0 0 1 8 0zm0 13a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0v-2A.5.5 0 0 1 8 13zm8-5a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1 0-1h2a.5.5 0 0 1 .5.5zM3 8a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1 0-1h2A.5.5 0 0 1 3 8zm10.657-5.657a.5.5 0 0 1 0 .707l-1.414 1.415a.5.5 0 1 1-.707-.708l1.414-1.414a.5.5 0 0 1 .707 0zm-9.193 9.193a.5.5 0 0 1 0 .707L3.05 13.657a.5.5 0 0 1-.707-.707l1.414-1.414a.5.5 0 0 1 .707 0zm9.193 2.121a.5.5 0 0 1-.707 0l-1.414-1.414a.5.5 0 0 1 .707-.707l1.414 1.414a.5.5 0 0 1 0 .707zM4.464 4.465a.5.5 0 0 1-.707 0L2.343 3.05a.5.5 0 1 1 .707-.707l1.414 1.414a.5.5 0 0 1 0 .708z"]);
        let st3: Symbol = new Symbol(this.GetThemeItem("dark").Id, viewBox, ["M6 .278a.768.768 0 0 1 .08.858 7.208 7.208 0 0 0-.878 3.46c0 4.021 3.278 7.277 7.318 7.277.527 0 1.04-.055 1.533-.16a.787.787 0 0 1 .81.316.733.733 0 0 1-.031.893A8.349 8.349 0 0 1 8.344 16C3.734 16 0 12.286 0 7.71 0 4.266 2.114 1.312 5.124.06A.752.752 0 0 1 6 .278z",
        ...
        let st4: Symbol = new Symbol(this.GetThemeItem("auto").Id, viewBox, ["M8 15A7 7 0 1 0 8 1v14zm0 1A8 8 0 1 1 8 0a8 8 0 0 1 0 16z"]);

        this._svg.addSymbol(st1);
        this._svg.addSymbol(st2);
        this._svg.addSymbol(st3);
        this._svg.addSymbol(st4);
        return this._svg;
    }
}
